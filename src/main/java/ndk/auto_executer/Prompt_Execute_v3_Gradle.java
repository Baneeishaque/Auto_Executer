 ...
 * @author manec
 */
public class Prompt_Execute_v3_Gradle extends Prompt_Execute_v3 implements Gradle_Properties {
    ...
    public static void main(String[] args) {
        Prompt_Execute_v3_Gradle prompt_Execute_v3_Gradle = new Prompt_Execute_v3_Gradle();
        prompt_Execute_v3_Gradle.execute();
    }
