 ...
 * @author manec
 */
public class Prompt_Execute_v3_Confirmation_Gradle extends Prompt_Execute_v3_Confirmation implements Gradle_Properties {
    ...
    public static void main(String[] args) {
        Prompt_Execute_v3_Confirmation_Gradle execute_v3_Confirmation_Gradle = new Prompt_Execute_v3_Confirmation_Gradle();
        execute_v3_Confirmation_Gradle.execute();
    }
